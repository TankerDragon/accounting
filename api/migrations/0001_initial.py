    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edited_load', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='edited', to='api.load')),
                ('original_load', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='original', to='api.load')),
            ],
        ),
    ]
